<template>
  ...
  <section class="py-16 px-4" style="background-color: #f8f6f0">
    <div class="max-w-3xl mx-auto">
      ...
      <div
        class="w-full h-64 md:h-80 rounded-2xl mb-12 flex flex-col items-center justify-center text-white text-center"
        style="background: linear-gradient(135deg, #8B4513, #ff6b35)"
      >
        <span class="text-6xl mb-3">🥜</span>
        <p class="text-lg font-semibold">The Nut Barn — Founders Photo Coming Soon</p>
        <p class="text-sm text-orange-200 mt-1">Est. 2023 · Dimondale, Michigan</p>
      </div>
      ...
      <div class="space-y-6 text-gray-700 text-lg leading-relaxed">
        ...
        <p>
          ...
          would say yes to buying this little nut stand because he's never told me "No" to anything
        ...
        <p>
          ...
          our community. Before long, we had "regulars" who would come to market just to see us for
        ...
        <p>
          People would follow the smell and say "Oh.. I am SO glad you're here!...we just LOVE
          these". Over time, we have come to recognize, and look forward to seeing, the friendly faces
  ...
  <section class="py-16 px-4" style="background-color: #ede9df">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div v-for="value in BRAND_VALUES" :key="value.title" class="card">
          <div class="text-3xl mb-3">{{ value.icon }}</div>
          <h3 class="text-lg font-bold mb-2" style="color: #8B4513">{{ value.title }}</h3>
          <p class="text-gray-600 text-sm leading-relaxed">{{ value.body }}</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-12 px-4 text-center text-white" style="background-color: #8B4513">
    <h2 class="text-2xl font-bold mb-3">Ready to Try Them?</h2>
    <p class="text-orange-200 mb-6">
      Order online or find us at the Holt Farmer's Market every Saturday.
    </p>
    <div class="flex flex-col sm:flex-row gap-3 justify-center">
      <NuxtLink href="/shop" class="btn-primary">Shop Online →</NuxtLink>
      <NuxtLink
        href="/find-us"
